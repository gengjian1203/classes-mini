...
###### [https://gitee.com/aaron-gao/image-cropper](https://gitee.com/aaron-gao/image-cropper)
...
Page({
  ...
  onLoad: function(options) {
    ...
    this.setData({
      src:
        "https://raw.githubusercontent.com/1977474741/image-cropper/dev/image/code.jpg",
    });
    wx.showLoading({
      title: "加载中",
    });
